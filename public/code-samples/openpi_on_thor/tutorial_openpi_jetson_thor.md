# OpenPi π₀.₅ on Jetson AGX Thor — TensorRT NVFP4 Deployment
...
<img src="openpi_on_thor/media/pi05-thor-perf.png" width="800" alt="π₀.₅ E2E Pipeline Latency on Jetson AGX Thor">
...
```bash
wget -qO- https://raw.githubusercontent.com/NVIDIA-AI-IOT/jetson-ai-lab-code-samples/main/tutorials/robotics/openpi_on_thor/download.sh | bash
```
...
- [OpenVLA on Jetson (related tutorial)](https://jetson-ai-lab.com/openvla.html)
